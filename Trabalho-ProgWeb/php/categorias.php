...
<div class="container">
    <div class="jumbotron">
        ...
        <hr>
        <div class="row">
            <a href="categoria_inserir.php" class="btn btn-success" style="margin-left:80%;"> Adicionar </a>
        </div>
        ...
        $query = "SELECT * 
FROM categoria ORDER BY nomeCategoria";
            ...
            if ($query_run) {
                while ($row = mysqli_fetch_array($query_run)) {
                    ...
                    <tr>
                        ...
                        <form action="categorias_deletar.php" method="post">
                            <input type="hidden" name='idCategoria' value="<?php echo $row['idCategoria'] ?>">
